...
class CommandLoggingCog(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        """Command error handler - logging disabled to only log successful executions"""
        # Command error logging is disabled - only log successful command executions
        # This prevents spam from cooldowns, permission errors, and other common issues
        pass
